...
const PreloadImages = () => (
  <div style={{ display: 'none' }}>
    ...
    <img src={A_AC_6_Tesla_Tower} alt='A_AC_6_Tesla_Tower' />
    <img src={FLAM_40_Incinerator} alt='FLAM_40_Incinerator' />
    <img src={REC_6_Demolisher} alt='REC_6_Demolisher' />
    <img src={AC_22_Dum_Dum} alt='AC_22_Dum_Dum' />
    <img src={Heavy_Strafing_Run} alt='Heavy_Strafing_Run' />
    <img src={Reinforce} alt='Reinforce' />
    <img src={AD_289_Angel} alt='AD_289_Angel' />
    <img src={Humblebee_UAV_drone} alt='Humblebee_UAV_drone' />
    <img src={REP_80} alt='REP_80' />
    <img src={AD_334_Guard_Dog} alt='AD_334_Guard_Dog' />
    <img src={Incendiary_Bombs} alt='Incendiary_Bombs' />
    <img src={Resupply_Pack} alt='Resupply_Pack' />
    <img src={A_GL_8_Launcher_Turret} alt='A_GL_8_Launcher_Turret' />
    <img src={LAS_98_Laser_Cannon} alt='LAS_98_Laser_Cannon' />
    <img src={Resupply} alt='Resupply' />
    <img
      src={Airdropped_Anti_Personnel_Mines}
      alt='Airdropped_Anti_Personnel_Mines'
    />
    <img src={LIFT_850_Jump_Pack} alt='LIFT_850_Jump_Pack' />
    <img src={RL_112_Recoilless_Rifle} alt='RL_112_Recoilless_Rifle' />
    <img src={Airdropped_Stun_Mines} alt='Airdropped_Stun_Mines' />
    <img src={M_25_Rumbler} alt='M_25_Rumbler' />
    <img src={SH_20_Shield_Generator_Pack} alt='SH_20_Shield_Generator_Pack' />
    <img src={Airstrike} alt='Airstrike' />
    <img src={M5_APC} alt='M5_APC' />
    <img
      src={SH_32_Directional_Kinetic_Shield}
      alt='SH_32_Directional_Kinetic_Shield'
    />
    <img src={A_MG_II_Minigun_Turret} alt='A_MG_II_Minigun_Turret' />
    <img src={M5_32_HAV} alt='M5_32_HAV' />
    <img src={Shredder_Missile_Strike} alt='Shredder_Missile_Strike' />
    <img src={Anti_Personnel_Barrier} alt='Anti_Personnel_Barrier' />
    <img src={MC_109_Hammer_Motorcycle} alt='MC_109_Hammer_Motorcycle' />
    <img src={Sledge_Precision_Artillery} alt='Sledge_Precision_Artillery' />
    <img src={A_RX_34_Railcannon_Turret} alt='A_RX_34_Railcannon_Turret' />
    <img src={ME_1_Sniffer_Metal_Detector} alt='ME_1_Sniffer_Metal_Detector' />
    <img src={Static_Field_Conductors} alt='Static_Field_Conductors' />
    <img src={AT_47_Anti_Tank_Emplacement} alt='AT_47_Anti_Tank_Emplacement' />
    <img src={MG_94_Machine_Gun} alt='MG_94_Machine_Gun' />
    <img src={Strafing_Run} alt='Strafing_Run' />
    <img src={Close_Air_Support} alt='Close_Air_Support' />
    <img src={MGX_42_Machine_Gun} alt='MGX_42_Machine_Gun' />
    <img src={TD_110_Bastion} alt='TD_110_Bastion' />
    <img src={Distractor_Beacon} alt='Distractor_Beacon' />
    <img src={Missile_Barrage} alt='Missile_Barrage' />
    <img src={Thunderer_Barrage} alt='Thunderer_Barrage' />
    <img src={EAT_17} alt='EAT_17' />
    <img src={MLS_4X_Commando} alt='MLS_4X_Commando' />
    <img src={Thunderer_Smoke_Round} alt='Thunderer_Smoke_Round' />
    <img src={Emergency_Beacon} alt='Emergency_Beacon' />
    <img src={NUX_223_Hellbomb} alt='NUX_223_Hellbomb' />
    <img src={TOX_13_Avenger} alt='TOX_13_Avenger' />
    <img src={EXO_44_Walker_Exosuit} alt='EXO_44_Walker_Exosuit' />
    <img
      src={Obliterator_Grenade_Launcher}
      alt='Obliterator_Grenade_Launcher'
    />
    <img src={Vindicator_Dive_Bomb} alt='Vindicator_Dive_Bomb' />
    <img src={EXO_48_Obsidian_Exosuit} alt='EXO_48_Obsidian_Exosuit' />
    <img src={Orbital_Laser_Strike} alt='Orbital_Laser_Strike' />
    <img src={EXO_51_Lumberer_Exosuit} alt='EXO_51_Lumberer_Exosuit' />
    <img src={Railcannon_Strike} alt='Railcannon_Strike' />
    <img src={Unrecognized} alt='Unrecognized' />
  </div>
);
